...
"border-radius: 5px")
        ...
        icon1 = QIcon()
        icon1.addFile(u"./../pys6-recipes-organizer-master/assets/icons/maximize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"./../pys6-recipes-organizer-master/assets/icons/restore-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border-radius: 1px;")
        ...
        self.frame.setGeometry(QRect(0, 0, 1390, 151))
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(0, 110, 1390, 481))
...
"")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.label_17.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Consulta cheques</span></p></body></html>", None))
