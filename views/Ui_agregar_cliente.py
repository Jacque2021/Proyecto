...
"")
        ...
        self.Desarrollo.setGeometry(QRect(10, 110, 1431, 491))
        ...
        self.frame_3.setGeometry(QRect(60, 20, 1011, 281))
        ...
        self.label_29.setGeometry(QRect(170, 50, 71, 25))
        ...
        self.nombre.setGeometry(QRect(240, 50, 721, 25))
        ...
        self.mensaje = QLabel(self.frame_3)
        self.mensaje.setObjectName(u"mensaje")
        self.mensaje.setGeometry(QRect(170, 240, 391, 21))
        font3 = QFont()
...
"font: 12pt \"Segoe UI\";")
    ...
    def retranslateUi(self, Agregar_cliente):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("Agregar_cliente", u"<html><head/><body><p align=\"center\">Agregar cliente</p></body></html>", None))
