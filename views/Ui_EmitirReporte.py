...
################################################################################
## Form generated from reading UI file 'EmitirReporte.ui'
##
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(0, 100, 1431, 581))
        ...
        self.Fecha.setGeometry(QRect(140, 80, 131, 31))
        self.Fecha.setStyleSheet(u"")
        self.fecha_1 = QDateEdit(self.Desarrollo)
        self.fecha_1.setObjectName(u"fecha_1")
        self.fecha_1.setGeometry(QRect(410, 80, 181, 31))
        self.fecha_1.setStyleSheet(u"border-style: solid;\n"
"border-width: 2px;\n"
"border-color: rgb(151, 153, 155);")
        self.fecha_1.setDateTime(QDateTime(QDate(2022, 4, 1), QTime(0, 0, 0)))
        self.codigo_cliente1 = QLineEdit(self.Desarrollo)
        self.codigo_cliente1.setObjectName(u"codigo_cliente1")
        self.codigo_cliente1.setGeometry(QRect(410, 140, 191, 31))
        self.codigo_cliente1.setStyleSheet(u"border-style: solid;\n"
"border-width: 2px;\n"
"border-color: rgb(151, 153, 155);")
        self.boton_imprimir = QPushButton(self.Desarrollo)
        self.boton_imprimir.setObjectName(u"boton_imprimir")
        self.boton_imprimir.setGeometry(QRect(650, 440, 101, 31))
        font2 = QFont()
        font2.setPointSize(12)
        self.boton_imprimir.setFont(font2)
        self.boton_imprimir.setStyleSheet(u"background-color: rgb(116, 170, 80);")
        self.fecha_2 = QDateEdit(self.Desarrollo)
        self.fecha_2.setObjectName(u"fecha_2")
        self.fecha_2.setGeometry(QRect(660, 80, 181, 31))
        self.fecha_2.setStyleSheet(u"border-style: solid;\n"
"border-width: 2px;\n"
"border-color: rgb(151, 153, 155);")
        self.fecha_2.setDateTime(QDateTime(QDate(2022, 4, 1), QTime(0, 0, 0)))
        self.codigo_cliente2 = QLineEdit(self.Desarrollo)
        self.codigo_cliente2.setObjectName(u"codigo_cliente2")
        self.codigo_cliente2.setGeometry(QRect(660, 140, 211, 31))
        self.codigo_cliente2.setStyleSheet(u"border-style: solid;\n"
"border-width: 2px;\n"
"border-color: rgb(151, 153, 155);")
        self.boton_buscar_fechas = QPushButton(self.Desarrollo)
        self.boton_buscar_fechas.setObjectName(u"boton_buscar_fechas")
        self.boton_buscar_fechas.setGeometry(QRect(1020, 110, 111, 31))
        self.boton_buscar_fechas.setFont(font2)
        self.boton_buscar_fechas.setStyleSheet(u"background-color: rgb(116, 170, 80);")
        ...
        self.tabla_clientes.setGeometry(QRect(120, 240, 1191, 161))
        self.tabla_clientes.setRowCount(4)
        ...
        self.label_23 = QLabel(self.Desarrollo)
        self.label_23.setObjectName(u"label_23")
        self.label_23.setGeometry(QRect(120, 30, 1211, 31))
        self.label_23.setStyleSheet(u"background-color: rgb(151, 153, 155);")
        self.Codigo_Clientes = QLabel(self.Desarrollo)
        self.Codigo_Clientes.setObjectName(u"Codigo_Clientes")
        self.Codigo_Clientes.setGeometry(QRect(140, 140, 191, 31))
        self.Codigo_Clientes.setStyleSheet(u"")
    ...
    def retranslateUi(self, Nuevoprestamo):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("Nuevoprestamo", u"<html><head/><body><p align=\"center\">Emitir reporte de ahorros</p></body></html>", None))
...
"de prestamos", None))
        self.Fecha.setText(QCoreApplication.translate("Nuevoprestamo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Rango de fechas</span></p><p align=\"center\"><br/></p></body></html>", None))
        self.boton_imprimir.setText(QCoreApplication.translate("Nuevoprestamo", u"Continuar", None))
        self.boton_buscar_fechas.setText(QCoreApplication.translate("Nuevoprestamo", u"Buscar", None))
        self.label_23.setText(QCoreApplication.translate("Nuevoprestamo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:700;\">Selecciona el filtro de busqueda para emitir los reportes deseados</span></p><p align=\"center\"><span style=\" font-weight:700;\"><br/></span></p></body></html>", None))
        self.Codigo_Clientes.setText(QCoreApplication.translate("Nuevoprestamo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Rango de ID de clientes</span></p><p align=\"center\"><br/></p></body></html>", None))
    # retranslateUi
