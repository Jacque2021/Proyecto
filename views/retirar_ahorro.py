...
################################################################################
## Form generated from reading UI file 'retirar_ahorro.ui'
##
...
"border-radius: 5px")
        ...
        icon3 = QIcon()
        icon3.addFile(u"./../pys6-recipes-organizer-master/assets/icons/close-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(0, 100, 1400, 561))
        ...
        self.primera_linea_3.setGeometry(QRect(320, 20, 701, 21))
...
"")
        ...
        self.frame_2.setGeometry(QRect(320, 40, 701, 371))
        self.frame_2.setFrameShape(QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QFrame.Raised)
        self.primera_linea_4 = QFrame(self.frame_2)
        self.primera_linea_4.setObjectName(u"primera_linea_4")
        self.primera_linea_4.setGeometry(QRect(0, 130, 1061, 21))
        self.primera_linea_4.setStyleSheet(u"background-color: rgb(151,153,155);\n"
"")
        self.primera_linea_4.setFrameShape(QFrame.StyledPanel)
        self.primera_linea_4.setFrameShadow(QFrame.Raised)
        self.datos_cliente_4 = QLabel(self.primera_linea_4)
        self.datos_cliente_4.setObjectName(u"datos_cliente_4")
        self.datos_cliente_4.setGeometry(QRect(10, 0, 171, 16))
        self.datos_cliente_4.setFont(font)
        self.frame_3 = QFrame(self.frame_2)
        self.frame_3.setObjectName(u"frame_3")
        self.frame_3.setGeometry(QRect(0, 150, 861, 411))
        self.frame_3.setFrameShape(QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QFrame.Raised)
        self.toolButton = QToolButton(self.frame_3)
        self.toolButton.setObjectName(u"toolButton")
        self.toolButton.setGeometry(QRect(320, 10, 20, 20))
        self.toolButton.setStyleSheet(u"border-style: solid;\n"
"border-width: 0px;")
        icon14 = QIcon()
        icon14.addFile(u"./../Proyecto - RESPALDO/assets/icons/search.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButton.setIcon(icon14)
        self.toolButton_2 = QToolButton(self.frame_3)
        self.toolButton_2.setObjectName(u"toolButton_2")
        self.toolButton_2.setGeometry(QRect(770, 10, 20, 20))
        self.toolButton_2.setStyleSheet(u"border-style: solid;\n"
"border-width: 0px;")
        self.toolButton_2.setIcon(icon14)
        self.label_35 = QLabel(self.frame_3)
        self.label_35.setObjectName(u"label_35")
        self.label_35.setGeometry(QRect(20, 20, 131, 16))
        font3 = QFont()
        font3.setPointSize(10)
        self.label_35.setFont(font3)
        self.caja_transaccion = QLineEdit(self.frame_3)
        self.caja_transaccion.setObjectName(u"caja_transaccion")
        self.caja_transaccion.setGeometry(QRect(120, 20, 171, 20))
        self.caja_transaccion.setStyleSheet(u"QLineEdit#caja_transaccion{border: 1px solid rgb(0,0,0);}")
        self.label_36 = QLabel(self.frame_3)
        self.label_36.setObjectName(u"label_36")
        self.label_36.setGeometry(QRect(20, 120, 131, 16))
        self.label_36.setFont(font3)
        self.caja_total_retiro = QLineEdit(self.frame_3)
        self.caja_total_retiro.setObjectName(u"caja_total_retiro")
        self.caja_total_retiro.setGeometry(QRect(120, 120, 171, 20))
        self.caja_total_retiro.setStyleSheet(u"QLineEdit#caja_total_retiro{border: 1px solid rgb(0,0,0);}")
        self.label_38 = QLabel(self.frame_3)
        self.label_38.setObjectName(u"label_38")
        self.label_38.setGeometry(QRect(20, 70, 111, 16))
        self.label_38.setFont(font3)
        self.caja_capital = QLineEdit(self.frame_3)
        self.caja_capital.setObjectName(u"caja_capital")
        self.caja_capital.setGeometry(QRect(130, 70, 161, 20))
        ...
        self.label_39.setGeometry(QRect(390, 120, 131, 16))
        self.label_39.setFont(font3)
        self.caja_descrpcion = QLineEdit(self.frame_3)
        self.caja_descrpcion.setObjectName(u"caja_descrpcion")
        self.caja_descrpcion.setGeometry(QRect(500, 120, 171, 71))
        self.caja_descrpcion.setStyleSheet(u"QLineEdit#caja_descrpcion{border: 1px solid rgb(0,0,0);}")
        self.frame_4 = QFrame(self.frame_3)
        self.frame_4.setObjectName(u"frame_4")
        self.frame_4.setGeometry(QRect(190, 280, 331, 31))
        self.frame_4.setFrameShape(QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QFrame.Raised)
        self.boton_retirar = QToolButton(self.frame_4)
        self.boton_retirar.setObjectName(u"boton_retirar")
        self.boton_retirar.setGeometry(QRect(90, 0, 71, 21))
        self.boton_retirar.setFont(font)
        self.boton_retirar.setStyleSheet(u"background-color: rgb(116,170,80);")
        self.boton_cancelar = QToolButton(self.frame_4)
        self.boton_cancelar.setObjectName(u"boton_cancelar")
        self.boton_cancelar.setGeometry(QRect(220, 0, 71, 21))
        self.boton_cancelar.setFont(font)
        self.boton_cancelar.setStyleSheet(u"background-color: rgb(116,170,80);")
        self.label_40 = QLabel(self.frame_3)
        self.label_40.setObjectName(u"label_40")
        self.label_40.setGeometry(QRect(390, 20, 111, 16))
        self.label_40.setFont(font3)
        self.label_41 = QLabel(self.frame_3)
        self.label_41.setObjectName(u"label_41")
        self.label_41.setGeometry(QRect(390, 60, 111, 16))
        self.label_41.setFont(font3)
        self.texto_error = QLabel(self.frame_3)
        self.texto_error.setObjectName(u"texto_error")
        self.texto_error.setGeometry(QRect(70, 150, 421, 32))
        self.texto_error.setMinimumSize(QSize(250, 0))
        self.texto_error.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font: 10pt \"Arial\";")
        self.texto_error_2 = QLabel(self.frame_3)
        self.texto_error_2.setObjectName(u"texto_error_2")
        self.texto_error_2.setGeometry(QRect(70, 190, 421, 32))
        self.texto_error_2.setMinimumSize(QSize(250, 0))
        self.texto_error_2.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font: 10pt \"Arial\";")
        self.texto_capital_n = QLabel(self.frame_3)
        self.texto_capital_n.setObjectName(u"texto_capital_n")
        self.texto_capital_n.setGeometry(QRect(130, 90, 421, 21))
        self.texto_capital_n.setMinimumSize(QSize(250, 0))
        self.texto_capital_n.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font: 10pt \"Arial\";")
        self.texto_error_3 = QLabel(self.frame_3)
        self.texto_error_3.setObjectName(u"texto_error_3")
        self.texto_error_3.setGeometry(QRect(60, 170, 421, 32))
        self.texto_error_3.setMinimumSize(QSize(250, 0))
        self.texto_error_3.setStyleSheet(u"color: rgb(48, 127, 226);\n"
"font: 10pt \"Arial\";")
        self.fechar = QLabel(self.frame_3)
        self.fechar.setObjectName(u"fechar")
        self.fechar.setGeometry(QRect(500, 20, 171, 21))
        ...
        self.horar.setGeometry(QRect(500, 60, 171, 21))
        ...
        self.id_c = QLineEdit(self.frame_2)
        ...
        self.label_56.setGeometry(QRect(120, 30, 61, 16))
        self.label_56.setFont(font3)
        self.nombre_c = QLineEdit(self.frame_2)
        ...
        self.label_57.setGeometry(QRect(370, 30, 61, 16))
        self.label_57.setFont(font3)
        self.apellidos_c = QLineEdit(self.frame_2)
        self.apellidos_c.setObjectName(u"apellidos_c")
        self.apellidos_c.setGeometry(QRect(450, 30, 251, 20))
        ...
        self.frame_5.setGeometry(QRect(490, 400, 331, 31))
        self.frame_5.setFrameShape(QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QFrame.Raised)
        self.boton_retirar_2 = QToolButton(self.frame_5)
        self.boton_retirar_2.setObjectName(u"boton_retirar_2")
        self.boton_retirar_2.setGeometry(QRect(90, 0, 71, 21))
        self.boton_retirar_2.setFont(font)
        self.boton_retirar_2.setStyleSheet(u"background-color: rgb(116,170,80);")
        self.boton_cancelar_2 = QToolButton(self.frame_5)
        self.boton_cancelar_2.setObjectName(u"boton_cancelar_2")
        self.boton_cancelar_2.setGeometry(QRect(220, 0, 71, 21))
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.label_17.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Retirar ahorro</span></p></body></html>", None))
...
"de prestamos", None))
        ...
        self.datos_cliente_4.setText(QCoreApplication.translate("DetailWindow", u"Informaci\u00f3n del retiro", None))
        self.toolButton.setText(QCoreApplication.translate("DetailWindow", u"...", None))
        self.toolButton_2.setText(QCoreApplication.translate("DetailWindow", u"...", None))
        self.label_35.setText(QCoreApplication.translate("DetailWindow", u"Transacci\u00f3n No.", None))
        self.label_36.setText(QCoreApplication.translate("DetailWindow", u"Total de retiro: ", None))
        self.label_38.setText(QCoreApplication.translate("DetailWindow", u"Capital ahorrado:", None))
        self.label_39.setText(QCoreApplication.translate("DetailWindow", u"Descripci\u00f3n:", None))
        self.boton_retirar.setText(QCoreApplication.translate("DetailWindow", u"Retirar", None))
        self.boton_cancelar.setText(QCoreApplication.translate("DetailWindow", u"Cancelar", None))
        self.label_40.setText(QCoreApplication.translate("DetailWindow", u"Fecha de retiro:", None))
        self.label_41.setText(QCoreApplication.translate("DetailWindow", u"Hora de retiro:", None))
...
#if QT_CONFIG(tooltip)
        self.texto_error_2.setToolTip(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.texto_error_2.setWhatsThis(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.texto_error_2.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.texto_capital_n.setToolTip(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.texto_capital_n.setWhatsThis(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.texto_capital_n.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.texto_error_3.setToolTip(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.texto_error_3.setWhatsThis(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.texto_error_3.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
        self.fechar.setText("")
        self.horar.setText("")
        ...
        self.boton_retirar_2.setText(QCoreApplication.translate("DetailWindow", u"Retirar", None))
