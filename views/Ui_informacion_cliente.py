...
################################################################################
## Form generated from reading UI file 'informacion_cliente.ui'
##
...
"")
    ...
    def retranslateUi(self, Agregar_cliente):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("Agregar_cliente", u"<html><head/><body><p align=\"center\">Informaci\u00f3n del cliente</p></body></html>", None))
