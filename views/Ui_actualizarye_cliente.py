...
################################################################################
## Form generated from reading UI file 'actualizarye_cliente.ui'
##
...
class Ui_act_eli_cliente(object):
    def setupUi(self, act_eli_cliente):
        if not act_eli_cliente.objectName():
            act_eli_cliente.setObjectName(u"act_eli_cliente")
        act_eli_cliente.resize(1410, 685)
        act_eli_cliente.setMinimumSize(QSize(1350, 0))
        act_eli_cliente.setStyleSheet(u"QWidget#DetailWindow{border-radius: 5px}")
        self.verticalLayout = QVBoxLayout(act_eli_cliente)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.central_widget_frame = QFrame(act_eli_cliente)
...
"border-radius: 5px")
        ...
        icon1 = QIcon()
        icon1.addFile(u"./../pys6-recipes-organizer-master/assets/icons/minimize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"./iconos/icons/restore-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.frame_3.setGeometry(QRect(130, 20, 1011, 251))
        ...
        self.fecha_de_nacimiento = QLabel(self.frame_3)
        ...
        self.fecha_de_nacimiento.setStyleSheet(u"QLabel#fecha_de_nacimiento{border: 1px solid rgb(0, 0, 0);}")
        self.codigo_cliente = QLabel(self.frame_3)
        self.codigo_cliente.setObjectName(u"codigo_cliente")
        self.codigo_cliente.setGeometry(QRect(270, 50, 201, 25))
        self.codigo_cliente.setMaximumSize(QSize(16777215, 25))
        self.codigo_cliente.setFont(font2)
        self.codigo_cliente.setStyleSheet(u"QLabel#codigo_cliente{border: 1px solid rgb(0, 0, 0);}")
        self.boton_actualizar = QPushButton(self.Desarrollo)
        self.boton_actualizar.setObjectName(u"boton_actualizar")
        self.boton_actualizar.setGeometry(QRect(660, 320, 75, 31))
        self.boton_actualizar.setFont(font2)
        self.boton_actualizar.setStyleSheet(u"background-color: rgb(116, 170, 80);")
        ...
        self.retranslateUi(act_eli_cliente)

        QMetaObject.connectSlotsByName(act_eli_cliente)
    # setupUi

    def retranslateUi(self, act_eli_cliente):
        act_eli_cliente.setWindowTitle(QCoreApplication.translate("act_eli_cliente", u"Form", None))
        self.title_label.setText("")
        self.close_button.setText("")
        self.minimize_button.setText("")
        self.maximize_button.setText("")
        self.restore_button.setText("")
        self.Empresa.setText(QCoreApplication.translate("act_eli_cliente", u"Empresa", None))
        self.Clientes.setText(QCoreApplication.translate("act_eli_cliente", u"Clientes", None))
        self.Prestamos.setText(QCoreApplication.translate("act_eli_cliente", u"Prestamos", None))
        self.Ahorros.setText(QCoreApplication.translate("act_eli_cliente", u"Ahorros", None))
        self.Consultas.setText(QCoreApplication.translate("act_eli_cliente", u"Consultas", None))
        self.Ayuda.setText(QCoreApplication.translate("act_eli_cliente", u"Ayuda", None))
        self.Salir.setText(QCoreApplication.translate("act_eli_cliente", u"Salir", None))
        self.Notificaciones.setText(QCoreApplication.translate("act_eli_cliente", u"Notificaciones", None))
        self.PolizaS.setText(QCoreApplication.translate("act_eli_cliente", u"Polizas", None))
        self.ChequeS.setText(QCoreApplication.translate("act_eli_cliente", u"Cheques", None))
        self.notify.setText("")
        self.label_18.setText("")
        self.label_17.setText(QCoreApplication.translate("act_eli_cliente", u"<html><head/><body><p align=\"center\">Actualizar cliente</p></body></html>", None))
        self.label_10.setText("")
        self.Catalogo.setText(QCoreApplication.translate("act_eli_cliente", u"Cat\u00e1logo de cuentas", None))
        self.Respaldo.setText(QCoreApplication.translate("act_eli_cliente", u"Respaldar empresa", None))
        self.Mi_Empresa.setText(QCoreApplication.translate("act_eli_cliente", u"Mi empresa", None))
        self.Ahorro.setText(QCoreApplication.translate("act_eli_cliente", u"Nuevo ahorro", None))
        self.abonar.setText(QCoreApplication.translate("act_eli_cliente", u"Abonar pago", None))
        self.Reportes.setText(QCoreApplication.translate("act_eli_cliente", u"Emitir reporte de ahorro", None))
        self.Polizas.setText(QCoreApplication.translate("act_eli_cliente", u"Nueva poliza", None))
        self.Historial.setText(QCoreApplication.translate("act_eli_cliente", u"Historial del cliente", None))
        self.Estado.setText(QCoreApplication.translate("act_eli_cliente", u"Estado de cuentas", None))
        self.cancelar.setText(QCoreApplication.translate("act_eli_cliente", u"Cancelar pago", None))
        self.Cliente.setText(QCoreApplication.translate("act_eli_cliente", u"Agregar nuevo cliente", None))
        self.Retirar.setText(QCoreApplication.translate("act_eli_cliente", u"Retirar ahorro", None))
        self.Cheques.setText(QCoreApplication.translate("act_eli_cliente", u"Cheques", None))
        self.Consulta_cheque.setText(QCoreApplication.translate("act_eli_cliente", u"Consultar cheques", None))
        self.Listado.setText(QCoreApplication.translate("act_eli_cliente", u"Listado de polizas", None))
        self.prestamo.setText(QCoreApplication.translate("act_eli_cliente", u"Nuevo prestamo", None))
        self.Reportes_2.setText(QCoreApplication.translate("act_eli_cliente", u"Emitir reporte \n"
"de prestamos", None))
        self.label_20.setText(QCoreApplication.translate("act_eli_cliente", u"ID del cliente:", None))
        self.label_19.setText(QCoreApplication.translate("act_eli_cliente", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">   Datos del cliente</span></p></body></html>", None))
        self.label_29.setText(QCoreApplication.translate("act_eli_cliente", u"Nombre:", None))
        self.nombre.setText("")
        self.label_21.setText(QCoreApplication.translate("act_eli_cliente", u"Tel\u00e9fono:", None))
        self.telefono.setText("")
        self.label_22.setText(QCoreApplication.translate("act_eli_cliente", u"Apellidos:", None))
        self.apellidos.setText("")
        self.label_28.setText(QCoreApplication.translate("act_eli_cliente", u"Direcci\u00f3n:", None))
        self.direccion.setText("")
        self.label_31.setText(QCoreApplication.translate("act_eli_cliente", u"Telefono adicional:", None))
        self.telefono_adicional.setText("")
        self.label_34.setText(QCoreApplication.translate("act_eli_cliente", u"Correo electr\u00f3nico:", None))
        self.correo_elec.setText("")
        self.label_36.setText(QCoreApplication.translate("act_eli_cliente", u"Fecha de nacimiento:", None))
        self.label_37.setText(QCoreApplication.translate("act_eli_cliente", u"Municipio:", None))
        self.puntuacion.setText("")
        self.label_35.setText(QCoreApplication.translate("act_eli_cliente", u"Puntuaci\u00f3n:", None))
        self.municipio.setText("")
        self.fecha_de_nacimiento.setText("")
        self.codigo_cliente.setText("")
        self.boton_actualizar.setText(QCoreApplication.translate("act_eli_cliente", u"Actualizar", None))
    # retranslateUi
