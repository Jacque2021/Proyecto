...
"border-radius: 5px")
        ...
        icon = QIcon()
        icon.addFile(u"./assets/Iconos/close-window.png", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"./assets/Iconos/close-window.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon1 = QIcon()
        icon1.addFile(u"./assets/Iconos/minimize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        icon1.addFile(u"./assets/Iconos/minimize-window.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.restore_button.setGeometry(QRect(110, 0, 28, 22))
        icon2 = QIcon()
        icon2.addFile(u"./assets/Iconos/restore-window.png", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u"./assets/Iconos/restore-window.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.maximize_button.setGeometry(QRect(110, 0, 31, 22))
        icon3 = QIcon()
        icon3.addFile(u"./assets/Iconos/maximize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        icon3.addFile(u"./assets/Iconos/maximize-window.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(20, 110, 1431, 481))
...
"")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Consulta cheques</span></p></body></html>", None))
