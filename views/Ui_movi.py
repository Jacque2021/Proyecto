...
################################################################################
## Form generated from reading UI file 'movi.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QRect(0, 0, 611, 521))
        self.frame.setStyleSheet(u"background-color: rgb(179, 179, 179)")
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.tabla_frame = QFrame(self.frame)
        self.tabla_frame.setObjectName(u"tabla_frame")
        self.tabla_frame.setGeometry(QRect(10, 40, 591, 461))
...
"")
        ...
        self.botones_frame = QFrame(self.frame)
        self.botones_frame.setObjectName(u"botones_frame")
        self.botones_frame.setGeometry(QRect(510, 10, 81, 31))
