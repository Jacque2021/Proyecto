...
class Ui_Catalogo_cuentas(object):
    def setupUi(self, Catalogo_cuentas):
        ...
        Catalogo_cuentas.resize(1410, 685)
        Catalogo_cuentas.setMinimumSize(QSize(1350, 0))
...
"")
        ...
        self.cuenta = QLineEdit(self.frame_3)
        self.cuenta.setObjectName(u"cuenta")
        self.cuenta.setGeometry(QRect(520, 40, 121, 20))
        self.cuenta.setMaximumSize(QSize(16777215, 20))
        self.cuenta.setFont(font2)
        self.cuenta.setStyleSheet(u"QLineEdit#cuenta{border: 1px solid rgb(0, 0, 0);}")
        ...
        self.label_20.setGeometry(QRect(460, 40, 60, 20))
    ...
    def retranslateUi(self, Catalogo_cuentas):
        ...
        self.label_17.setText(QCoreApplication.translate("Catalogo_cuentas", u"<html><head/><body><p align=\"center\">Cat\u00e1logo de cuentas</p></body></html>", None))
        ...
        self.Reportes.setText(QCoreApplication.translate("Catalogo_cuentas", u"Emitir reporte de ahorro", None))
...
"de prestamos", None))
        ...
        self.label_20.setText(QCoreApplication.translate("Catalogo_cuentas", u"Cuenta:", None))
