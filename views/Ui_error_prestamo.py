...
################################################################################
## Form generated from reading UI file 'error_prestamo.ui'
##
...
"")
    ...
    def retranslateUi(self, InicioSesion):
        ...
        self.label_3.setText(QCoreApplication.translate("InicioSesion", u"todos los datos!!!", None))
        self.label.setText(QCoreApplication.translate("InicioSesion", u"Debes de ingresar", None))
    # retranslateUi
