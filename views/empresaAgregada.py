...
################################################################################
## Form generated from reading UI file 'empresaAgregada.ui'
##
...
"background-color: rgb(48, 127, 226);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Empresa agregada</span></p></body></html>", None))
