...
"background-color: rgb(249, 66, 58);")
    ...
    def retranslateUi(self, error_cliente):
        ...
        self.label_3.setText(QCoreApplication.translate("error_cliente", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Los datos del servidor</span></p></body></html>", None))
        self.Ok.setText(QCoreApplication.translate("error_cliente", u"Ok", None))
        self.label_4.setText(QCoreApplication.translate("error_cliente", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">son incorrectos.</span></p></body></html>", None))
    # retranslateUi
