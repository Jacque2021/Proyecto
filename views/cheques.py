...
################################################################################
## Form generated from reading UI file 'chequess.ui'
##
...
"border-radius: 1px;")
        ...
        self.IngresaTitulo.setGeometry(QRect(220, 10, 841, 61))
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(-30, 140, 1431, 471))
...
"font: 10pt \"Arial\";")
        ...
        self.fechaf.setGeometry(QRect(150, 170, 171, 21))
...
"")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Cheques</span></p></body></html>", None))
