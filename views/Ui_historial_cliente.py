...
class Ui_historial_cliente(object):
    def setupUi(self, historial_cliente):
        ...
        historial_cliente.resize(1410, 685)
        historial_cliente.setMinimumSize(QSize(1350, 0))
...
"")
    ...
    def retranslateUi(self, historial_cliente):
        ...
        self.label_17.setText(QCoreApplication.translate("historial_cliente", u"<html><head/><body><p align=\"center\">Historial del cliente</p></body></html>", None))
        ...
        self.Reportes.setText(QCoreApplication.translate("historial_cliente", u"Emitir reporte de ahorro", None))
