...
################################################################################
## Form generated from reading UI file 'cliente_borrado.ui'
##
...
class Ui_eliminado_cliente(object):
...
"background-color: rgb(249, 66, 58);")
        ...
        self.label_2.setGeometry(QRect(40, 40, 181, 41))
        ...
        self.label_4.setGeometry(QRect(60, 80, 141, 41))
    ...
    def retranslateUi(self, error_cliente):
        ...
        self.label_2.setText(QCoreApplication.translate("error_cliente", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Cliente eliminado</span></p></body></html>", None))
        self.Ok.setText(QCoreApplication.translate("error_cliente", u"Ok", None))
        self.label_4.setText(QCoreApplication.translate("error_cliente", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Exitosamente</span></p></body></html>", None))
    # retranslateUi
