...
################################################################################
## Form generated from reading UI file 'consulta_cliente.ui'
##
...
"border-with 0px;")
        icon = QIcon()
        icon.addFile(u"./assets/Iconos/minimize-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border-with 0px;")
        icon1 = QIcon()
        icon1.addFile(u"./assets/Iconos/close-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.tabla_clientes.setGeometry(QRect(20, 40, 461, 161))
        self.tabla_clientes.setRowCount(4)
