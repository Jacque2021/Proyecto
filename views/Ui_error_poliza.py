...
################################################################################
## Form generated from reading UI file 'error_poliza.ui'
##
...
"")
    ...
    def retranslateUi(self, Error_PDF):
        ...
        self.label_3.setText(QCoreApplication.translate("Error_PDF", u"               de p\u00f3liza", None))
#if QT_CONFIG(tooltip)
        self.label.setToolTip(QCoreApplication.translate("Error_PDF", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("Error_PDF", u"  No se encontro el n\u00famero", None))
    # retranslateUi
