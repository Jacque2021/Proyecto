...
################################################################################
## Form generated from reading UI file 'historial_cliente_prestamo.ui'
##
...
class Ui_historial_cliente_p(object):
    def setupUi(self, historial_cliente_p):
        if not historial_cliente_p.objectName():
            historial_cliente_p.setObjectName(u"historial_cliente_p")
        historial_cliente_p.resize(1350, 693)
        historial_cliente_p.setStyleSheet(u"QWidget#DetailWindow{border-radius: 5px}")
        self.verticalLayout = QVBoxLayout(historial_cliente_p)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.central_widget_frame = QFrame(historial_cliente_p)
...
"")
        ...
        self.tabla_clientes.setGeometry(QRect(10, 110, 601, 191))
        self.tabla_clientes.setRowCount(4)
        ...
        self.retranslateUi(historial_cliente_p)

        QMetaObject.connectSlotsByName(historial_cliente_p)
    # setupUi

    def retranslateUi(self, historial_cliente_p):
        historial_cliente_p.setWindowTitle(QCoreApplication.translate("historial_cliente_p", u"Form", None))
        self.title_label.setText("")
        self.restore_button.setText("")
        self.close_button.setText("")
        self.maximize_button.setText("")
        self.minimize_button.setText("")
        self.Empresa.setText(QCoreApplication.translate("historial_cliente_p", u"Empresa", None))
        self.Clientes.setText(QCoreApplication.translate("historial_cliente_p", u"Clientes", None))
        self.Prestamos.setText(QCoreApplication.translate("historial_cliente_p", u"Prestamos", None))
        self.Ahorros.setText(QCoreApplication.translate("historial_cliente_p", u"Ahorros", None))
        self.Consultas.setText(QCoreApplication.translate("historial_cliente_p", u"Consultas", None))
        self.Ayuda.setText(QCoreApplication.translate("historial_cliente_p", u"Ayuda", None))
        self.Salir.setText(QCoreApplication.translate("historial_cliente_p", u"Salir", None))
        self.Notificaciones.setText(QCoreApplication.translate("historial_cliente_p", u"Notificaciones", None))
        self.PolizaS.setText(QCoreApplication.translate("historial_cliente_p", u"Polizas", None))
        self.ChequeS.setText(QCoreApplication.translate("historial_cliente_p", u"Cheques", None))
        self.notify.setText(QCoreApplication.translate("historial_cliente_p", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
        self.label_18.setText("")
        self.IngresaTitulo.setText(QCoreApplication.translate("historial_cliente_p", u"<html><head/><body><p align=\"center\">Historial del cliente por pr\u00e9stamo</p></body></html>", None))
        self.label_10.setText("")
        self.Catalogo.setText(QCoreApplication.translate("historial_cliente_p", u"Cat\u00e1logo de cuentas", None))
        self.Respaldo.setText(QCoreApplication.translate("historial_cliente_p", u"Respaldar empresa", None))
        self.Mi_Empresa.setText(QCoreApplication.translate("historial_cliente_p", u"Mi empresa", None))
        self.Ahorro.setText(QCoreApplication.translate("historial_cliente_p", u"Nuevo ahorro", None))
        self.abonar.setText(QCoreApplication.translate("historial_cliente_p", u"Abonar pago", None))
        self.Reportes.setText(QCoreApplication.translate("historial_cliente_p", u"Emitir reporte", None))
        self.Polizas.setText(QCoreApplication.translate("historial_cliente_p", u"Nueva poliza", None))
        self.Historial.setText(QCoreApplication.translate("historial_cliente_p", u"Historial del cliente", None))
        self.Estado.setText(QCoreApplication.translate("historial_cliente_p", u"Estado de cuentas", None))
        self.cancelar.setText(QCoreApplication.translate("historial_cliente_p", u"Cancelar pago", None))
        self.Cliente.setText(QCoreApplication.translate("historial_cliente_p", u"Agregar nuevo cliente", None))
        self.Retirar.setText(QCoreApplication.translate("historial_cliente_p", u"Retirar ahorro", None))
        self.Cheques.setText(QCoreApplication.translate("historial_cliente_p", u"Cheques", None))
        self.Consulta_cheque.setText(QCoreApplication.translate("historial_cliente_p", u"Consultar cheques", None))
        self.Listado.setText(QCoreApplication.translate("historial_cliente_p", u"Listado de polizas", None))
        self.prestamo.setText(QCoreApplication.translate("historial_cliente_p", u"Nuevo prestamo", None))
        self.Reportes_2.setText(QCoreApplication.translate("historial_cliente_p", u"Emitir reporte \n"
"de prestamos", None))
        self.boton_b_apellidos.setText(QCoreApplication.translate("historial_cliente_p", u"Buscar", None))
        self.boton_b_ID.setText(QCoreApplication.translate("historial_cliente_p", u"Buscar", None))
        self.boton_b_nombre.setText(QCoreApplication.translate("historial_cliente_p", u"buscar", None))
        self.label_20.setText(QCoreApplication.translate("historial_cliente_p", u"Buscar por nombre del cliente:", None))
        self.label_22.setText(QCoreApplication.translate("historial_cliente_p", u"Buscar por ID del cliente:", None))
        self.label_21.setText(QCoreApplication.translate("historial_cliente_p", u"Buscar por apellidos del cliente:", None))
        self.boton_imprimir.setText(QCoreApplication.translate("historial_cliente_p", u"Imprimir", None))
    # retranslateUi
