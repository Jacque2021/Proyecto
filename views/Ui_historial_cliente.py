...
################################################################################
## Form generated from reading UI file 'historial_cliente.ui'
##
...
class Ui_historial_cliente(object):
    def setupUi(self, historial_cliente):
        if not historial_cliente.objectName():
            historial_cliente.setObjectName(u"historial_cliente")
        historial_cliente.resize(1350, 693)
        historial_cliente.setStyleSheet(u"QWidget#DetailWindow{border-radius: 5px}")
        self.verticalLayout = QVBoxLayout(historial_cliente)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.central_widget_frame = QFrame(historial_cliente)
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(10, 130, 1431, 491))
        ...
        self.tabla_clientes.setGeometry(QRect(10, 110, 1141, 191))
        self.tabla_clientes.setRowCount(4)
        ...
        self.b_prestamo = QPushButton(self.Desarrollo)
        self.b_prestamo.setObjectName(u"b_prestamo")
        self.b_prestamo.setGeometry(QRect(10, 380, 241, 31))
        self.b_prestamo.setFont(font2)
        self.b_prestamo.setStyleSheet(u"background-color: rgb(116, 170, 80);")
        self.ahorro = QPushButton(self.Desarrollo)
        self.ahorro.setObjectName(u"ahorro")
        self.ahorro.setGeometry(QRect(100, 340, 231, 31))
        self.ahorro.setFont(font2)
        self.ahorro.setStyleSheet(u"background-color: rgb(116, 170, 80);")
        ...
        self.retranslateUi(historial_cliente)

        QMetaObject.connectSlotsByName(historial_cliente)
    # setupUi

    def retranslateUi(self, historial_cliente):
        historial_cliente.setWindowTitle(QCoreApplication.translate("historial_cliente", u"Form", None))
        self.title_label.setText("")
        self.restore_button.setText("")
        self.close_button.setText("")
        self.maximize_button.setText("")
        self.minimize_button.setText("")
        self.Empresa.setText(QCoreApplication.translate("historial_cliente", u"Empresa", None))
        self.Clientes.setText(QCoreApplication.translate("historial_cliente", u"Clientes", None))
        self.Prestamos.setText(QCoreApplication.translate("historial_cliente", u"Prestamos", None))
        self.Ahorros.setText(QCoreApplication.translate("historial_cliente", u"Ahorros", None))
        self.Consultas.setText(QCoreApplication.translate("historial_cliente", u"Consultas", None))
        self.Ayuda.setText(QCoreApplication.translate("historial_cliente", u"Ayuda", None))
        self.Salir.setText(QCoreApplication.translate("historial_cliente", u"Salir", None))
        self.Notificaciones.setText(QCoreApplication.translate("historial_cliente", u"Notificaciones", None))
        self.PolizaS.setText(QCoreApplication.translate("historial_cliente", u"Polizas", None))
        self.ChequeS.setText(QCoreApplication.translate("historial_cliente", u"Cheques", None))
        self.notify.setText(QCoreApplication.translate("historial_cliente", u"<html><head/><body><p align=\"center\"><br/></p></body></html>", None))
        self.label_18.setText("")
        self.IngresaTitulo.setText(QCoreApplication.translate("historial_cliente", u"<html><head/><body><p align=\"center\">Historial del cliente</p></body></html>", None))
        self.label_10.setText("")
        self.Catalogo.setText(QCoreApplication.translate("historial_cliente", u"Cat\u00e1logo de cuentas", None))
        self.Respaldo.setText(QCoreApplication.translate("historial_cliente", u"Respaldar empresa", None))
        self.Mi_Empresa.setText(QCoreApplication.translate("historial_cliente", u"Mi empresa", None))
        self.Ahorro.setText(QCoreApplication.translate("historial_cliente", u"Nuevo ahorro", None))
        self.abonar.setText(QCoreApplication.translate("historial_cliente", u"Abonar pago", None))
        self.Reportes.setText(QCoreApplication.translate("historial_cliente", u"Emitir reporte", None))
        self.Polizas.setText(QCoreApplication.translate("historial_cliente", u"Nueva poliza", None))
        self.Historial.setText(QCoreApplication.translate("historial_cliente", u"Historial del cliente", None))
        self.Estado.setText(QCoreApplication.translate("historial_cliente", u"Estado de cuentas", None))
        self.cancelar.setText(QCoreApplication.translate("historial_cliente", u"Cancelar pago", None))
        self.Cliente.setText(QCoreApplication.translate("historial_cliente", u"Agregar nuevo cliente", None))
        self.Retirar.setText(QCoreApplication.translate("historial_cliente", u"Retirar ahorro", None))
        self.Cheques.setText(QCoreApplication.translate("historial_cliente", u"Cheques", None))
        self.Consulta_cheque.setText(QCoreApplication.translate("historial_cliente", u"Consultar cheques", None))
        self.Listado.setText(QCoreApplication.translate("historial_cliente", u"Listado de polizas", None))
        self.prestamo.setText(QCoreApplication.translate("historial_cliente", u"Nuevo prestamo", None))
        self.Reportes_2.setText(QCoreApplication.translate("historial_cliente", u"Emitir reporte \n"
"de prestamos", None))
        self.boton_b_apellidos.setText(QCoreApplication.translate("historial_cliente", u"Buscar", None))
        self.boton_b_ID.setText(QCoreApplication.translate("historial_cliente", u"Buscar", None))
        self.boton_b_nombre.setText(QCoreApplication.translate("historial_cliente", u"buscar", None))
        self.label_20.setText(QCoreApplication.translate("historial_cliente", u"Buscar por nombre del cliente:", None))
        self.label_22.setText(QCoreApplication.translate("historial_cliente", u"Buscar por ID del cliente:", None))
        self.label_21.setText(QCoreApplication.translate("historial_cliente", u"Buscar por apellidos del cliente:", None))
        self.boton_imprimir.setText(QCoreApplication.translate("historial_cliente", u"Imprimir", None))
        self.b_prestamo.setText(QCoreApplication.translate("historial_cliente", u"Historial del cliente por pr\u00e9stamos", None))
        self.ahorro.setText(QCoreApplication.translate("historial_cliente", u"Historial del cliente por ahorros", None))
    # retranslateUi
