...
################################################################################
## Form generated from reading UI file 'mi_empresa.ui'
##
...
"border-radius: 5px")
        ...
        self.barra_principal_frame.setMinimumSize(QSize(1350, 20))
...
"border-radius: 1px;")
        ...
        self.frame.setGeometry(QRect(0, 0, 1431, 121))
...
"")
        ...
        self.Desarrollo.setGeometry(QRect(0, 120, 1431, 471))
        ...
        self.contenido_frame_bajo = QFrame(self.Desarrollo)
        self.contenido_frame_bajo.setObjectName(u"contenido_frame_bajo")
        self.contenido_frame_bajo.setGeometry(QRect(320, 70, 701, 521))
        self.contenido_frame_bajo.setFrameShape(QFrame.StyledPanel)
        self.contenido_frame_bajo.setFrameShadow(QFrame.Raised)
        self.titulo_rfc = QLabel(self.contenido_frame_bajo)
        self.titulo_rfc.setObjectName(u"titulo_rfc")
        self.titulo_rfc.setGeometry(QRect(0, 10, 121, 16))
        font3 = QFont()
        font3.setPointSize(10)
        self.titulo_rfc.setFont(font3)
        self.caja_rfc = QLineEdit(self.contenido_frame_bajo)
        self.caja_rfc.setObjectName(u"caja_rfc")
        self.caja_rfc.setGeometry(QRect(130, 10, 191, 20))
        self.caja_rfc.setStyleSheet(u"QLineEdit#caja_rfc{border: 1px solid rgb(0,0,0);}")
        self.boton_guardar = QToolButton(self.contenido_frame_bajo)
        self.boton_guardar.setObjectName(u"boton_guardar")
        self.boton_guardar.setGeometry(QRect(340, 320, 71, 21))
        self.boton_guardar.setFont(font)
        self.boton_guardar.setStyleSheet(u"background-color: rgb(116,170,80);")
        self.titulo_iniciol = QLabel(self.contenido_frame_bajo)
        self.titulo_iniciol.setObjectName(u"titulo_iniciol")
        self.titulo_iniciol.setGeometry(QRect(380, 10, 111, 16))
        self.titulo_iniciol.setFont(font3)
        self.titulo_fin = QLabel(self.contenido_frame_bajo)
        self.titulo_fin.setObjectName(u"titulo_fin")
        self.titulo_fin.setGeometry(QRect(380, 50, 111, 16))
        self.titulo_fin.setFont(font3)
        self.fecha_fin = QDateEdit(self.contenido_frame_bajo)
        self.fecha_fin.setObjectName(u"fecha_fin")
        self.fecha_fin.setGeometry(QRect(500, 50, 181, 22))
        self.fecha_fin.setStyleSheet(u"QDateEdit#fecha_fin{border: 1px solid rgb(0,0,0);}")
        self.linea_ubicacion = QFrame(self.contenido_frame_bajo)
        self.linea_ubicacion.setObjectName(u"linea_ubicacion")
        self.linea_ubicacion.setGeometry(QRect(0, 130, 321, 21))
        self.linea_ubicacion.setStyleSheet(u"background-color: rgb(151,153,155);\n"
"")
        self.linea_ubicacion.setFrameShape(QFrame.StyledPanel)
        self.linea_ubicacion.setFrameShadow(QFrame.Raised)
        self.datos_cliente_7 = QLabel(self.linea_ubicacion)
        self.datos_cliente_7.setObjectName(u"datos_cliente_7")
        self.datos_cliente_7.setGeometry(QRect(10, 0, 211, 16))
        self.datos_cliente_7.setFont(font)
        self.linea_periodos = QFrame(self.contenido_frame_bajo)
        self.linea_periodos.setObjectName(u"linea_periodos")
        self.linea_periodos.setGeometry(QRect(380, 130, 321, 21))
        self.linea_periodos.setStyleSheet(u"background-color: rgb(151,153,155);\n"
"")
        self.linea_periodos.setFrameShape(QFrame.StyledPanel)
        self.linea_periodos.setFrameShadow(QFrame.Raised)
        self.datos_cliente_9 = QLabel(self.linea_periodos)
        self.datos_cliente_9.setObjectName(u"datos_cliente_9")
        self.datos_cliente_9.setGeometry(QRect(10, 0, 211, 16))
        self.datos_cliente_9.setFont(font)
        self.titulo_servidor = QLabel(self.contenido_frame_bajo)
        self.titulo_servidor.setObjectName(u"titulo_servidor")
        self.titulo_servidor.setGeometry(QRect(10, 170, 171, 16))
        self.titulo_servidor.setFont(font3)
        self.caja_usuario = QLineEdit(self.contenido_frame_bajo)
        self.caja_usuario.setObjectName(u"caja_usuario")
        self.caja_usuario.setGeometry(QRect(90, 170, 231, 20))
        self.caja_usuario.setStyleSheet(u"QLineEdit#caja_usuario{border: 1px solid rgb(0,0,0);}")
        self.titulo_base = QLabel(self.contenido_frame_bajo)
        self.titulo_base.setObjectName(u"titulo_base")
        self.titulo_base.setGeometry(QRect(10, 200, 101, 16))
        self.titulo_base.setFont(font3)
        self.caja_contrasena = QLineEdit(self.contenido_frame_bajo)
        self.caja_contrasena.setObjectName(u"caja_contrasena")
        self.caja_contrasena.setGeometry(QRect(90, 200, 231, 20))
        self.caja_contrasena.setStyleSheet(u"QLineEdit#caja_contrasena{border: 1px solid rgb(0,0,0);}")
        self.titulo_ubicacion = QLabel(self.contenido_frame_bajo)
        self.titulo_ubicacion.setObjectName(u"titulo_ubicacion")
        self.titulo_ubicacion.setGeometry(QRect(10, 230, 181, 16))
        self.titulo_ubicacion.setFont(font3)
        self.caja_host = QLineEdit(self.contenido_frame_bajo)
        self.caja_host.setObjectName(u"caja_host")
        self.caja_host.setGeometry(QRect(90, 230, 231, 20))
        self.caja_host.setStyleSheet(u"QLineEdit#caja_host{border: 1px solid rgb(0,0,0);}")
        self.titulo_tipop = QLabel(self.contenido_frame_bajo)
        self.titulo_tipop.setObjectName(u"titulo_tipop")
        self.titulo_tipop.setGeometry(QRect(380, 170, 111, 16))
        self.titulo_tipop.setFont(font3)
        self.titulo_rfc_2 = QLabel(self.contenido_frame_bajo)
        self.titulo_rfc_2.setObjectName(u"titulo_rfc_2")
        self.titulo_rfc_2.setGeometry(QRect(0, 50, 151, 16))
        self.titulo_rfc_2.setFont(font3)
        self.caja_ubicacion_bd = QLineEdit(self.contenido_frame_bajo)
        self.caja_ubicacion_bd.setObjectName(u"caja_ubicacion_bd")
        self.caja_ubicacion_bd.setGeometry(QRect(150, 50, 171, 20))
        self.caja_ubicacion_bd.setStyleSheet(u"QLineEdit#caja_ubicacion_bd{border: 1px solid rgb(0,0,0);}")
        self.caja_periodo = QLineEdit(self.contenido_frame_bajo)
        self.caja_periodo.setObjectName(u"caja_periodo")
        self.caja_periodo.setGeometry(QRect(500, 170, 181, 20))
        self.caja_periodo.setStyleSheet(u"QLineEdit#caja_periodo{border: 1px solid rgb(0,0,0);}")
        self.titulo_ubicacion_2 = QLabel(self.contenido_frame_bajo)
        self.titulo_ubicacion_2.setObjectName(u"titulo_ubicacion_2")
        self.titulo_ubicacion_2.setGeometry(QRect(10, 260, 181, 16))
        self.titulo_ubicacion_2.setFont(font3)
        self.caja_base = QLineEdit(self.contenido_frame_bajo)
        self.caja_base.setObjectName(u"caja_base")
        self.caja_base.setGeometry(QRect(100, 260, 221, 20))
        self.caja_base.setStyleSheet(u"QLineEdit#caja_base{border: 1px solid rgb(0,0,0);}")
        self.fechar = QLabel(self.contenido_frame_bajo)
        self.fechar.setObjectName(u"fechar")
        self.fechar.setGeometry(QRect(500, 10, 181, 21))
        self.fechar.setStyleSheet(u"QLabel#fechar{border: 1px solid rgb(0,0,0);}")
        self.linea_datosg = QFrame(self.Desarrollo)
        self.linea_datosg.setObjectName(u"linea_datosg")
        self.linea_datosg.setGeometry(QRect(320, 50, 321, 21))
        self.linea_datosg.setStyleSheet(u"background-color: rgb(151,153,155);\n"
"")
        self.linea_datosg.setFrameShape(QFrame.StyledPanel)
        self.linea_datosg.setFrameShadow(QFrame.Raised)
        self.datos_cliente_3 = QLabel(self.linea_datosg)
        self.datos_cliente_3.setObjectName(u"datos_cliente_3")
        self.datos_cliente_3.setGeometry(QRect(10, 0, 211, 16))
        self.datos_cliente_3.setFont(font)
        self.linea_historia = QFrame(self.Desarrollo)
        self.linea_historia.setObjectName(u"linea_historia")
        self.linea_historia.setGeometry(QRect(700, 50, 321, 21))
        self.linea_historia.setStyleSheet(u"background-color: rgb(151,153,155);\n"
"")
        self.linea_historia.setFrameShape(QFrame.StyledPanel)
        self.linea_historia.setFrameShadow(QFrame.Raised)
        self.datos_cliente_5 = QLabel(self.linea_historia)
        self.datos_cliente_5.setObjectName(u"datos_cliente_5")
        self.datos_cliente_5.setGeometry(QRect(10, 0, 211, 16))
        self.datos_cliente_5.setFont(font)
        self.titutlo_nom_emp = QLabel(self.Desarrollo)
        self.titutlo_nom_emp.setObjectName(u"titutlo_nom_emp")
        self.titutlo_nom_emp.setGeometry(QRect(320, 20, 141, 16))
        self.titutlo_nom_emp.setFont(font3)
        self.caja_empresa = QLineEdit(self.Desarrollo)
        self.caja_empresa.setObjectName(u"caja_empresa")
        self.caja_empresa.setGeometry(QRect(470, 20, 551, 20))
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.label_17.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Mi empresa</span></p></body></html>", None))
...
"de prestamos", None))
        ...
        self.titulo_rfc.setText(QCoreApplication.translate("DetailWindow", u"RFC de la empresa:", None))
        self.boton_guardar.setText(QCoreApplication.translate("DetailWindow", u"Guardar", None))
        self.titulo_iniciol.setText(QCoreApplication.translate("DetailWindow", u"Inicio del ejercicio:", None))
        self.titulo_fin.setText(QCoreApplication.translate("DetailWindow", u"Fin del ejercicio:", None))
        self.datos_cliente_7.setText(QCoreApplication.translate("DetailWindow", u"Datos generales del servidor", None))
        self.datos_cliente_9.setText(QCoreApplication.translate("DetailWindow", u"Periodos contables", None))
        self.titulo_servidor.setText(QCoreApplication.translate("DetailWindow", u"Usuario:", None))
        self.titulo_base.setText(QCoreApplication.translate("DetailWindow", u"Contrase\u00f1a:", None))
        self.titulo_ubicacion.setText(QCoreApplication.translate("DetailWindow", u"Host: ", None))
        self.titulo_tipop.setText(QCoreApplication.translate("DetailWindow", u"Tipo del periodo:", None))
        self.titulo_rfc_2.setText(QCoreApplication.translate("DetailWindow", u"Ubicaci\u00f3n de la empresa:", None))
        self.titulo_ubicacion_2.setText(QCoreApplication.translate("DetailWindow", u"Base de datos:", None))
        self.fechar.setText("")
        self.datos_cliente_3.setText(QCoreApplication.translate("DetailWindow", u"Datos generales de la empresa", None))
        self.datos_cliente_5.setText(QCoreApplication.translate("DetailWindow", u"Inicio de historia", None))
        self.titutlo_nom_emp.setText(QCoreApplication.translate("DetailWindow", u"Nombre de la empresa: ", None))
    # retranslateUi
