...
################################################################################
## Form generated from reading UI file 'resp.ui'
##
...
"border-radius: 5px")
        ...
        icon1 = QIcon()
        icon1.addFile(u"./assets/Iconos/restore-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"./assets/Iconos/maximize-window.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.Desarrollo_2 = QFrame(self.Desarrollo)
        self.Desarrollo_2.setObjectName(u"Desarrollo_2")
        self.Desarrollo_2.setGeometry(QRect(-40, 0, 1431, 481))
...
"")
    ...
    def retranslateUi(self, DetailWindow):
        ...
        self.IngresaTitulo.setText(QCoreApplication.translate("DetailWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Respaldar empresa</span></p></body></html>", None))
