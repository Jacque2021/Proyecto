...
class buscar_empresa_poli(QWidget, Ui_consulta_empresa):
    ...
    def  config_table_1(self): #MEDIDAS DE LA TABLA
        column_labels=("RFC", "NOMBRE EMPRESA","CODIGO SAT")
        ...
        self.tabla_empresa.setColumnWidth(1, 120) #ancho de la celda Nombre
        self.tabla_empresa.setColumnWidth(2, 100) #ancho de la celda Nombre
    ...
    def set_table_data_1(self):
        data=recipes.select_tabal_clientes_2()  
