...
################################################################################
## Form generated from reading UI file 'consulta_re_ahorro_tabla.ui'
##
...
"")
        ...
        self.botones_frame.setGeometry(QRect(330, 10, 81, 31))
...
"")
        ...
        self.tabla_cheques.setGeometry(QRect(20, 40, 381, 161))
        self.tabla_cheques.setRowCount(4)
